...
test("configures HTTP_PROXY, HTTPS_PROXY, and NO_PROXY for global fetch", async (t) => {
  ...
  const proxy = createServer((req, res) => {
    forwardedRequests.push({ host: req.headers.host, url: req.url });
  ...
  assert.deepEqual(forwardedRequests, [{ host: "target.invalid", url: "http://target.invalid/through-http-proxy" }]);
