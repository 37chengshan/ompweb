...
const { deleteMcpServer, parseMcpListOutput, readMcpConfig, readUserMcpConfig, redactMcpServer, validateMcpServer, writeMcpServer } = await jiti.import("./mcp-config.ts");
...
test("redacts project MCP credentials and preserves them on an edited save", () => {
  withWorkspace((cwd) => {
